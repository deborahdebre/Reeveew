                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card revenue-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                            <i style="color: red" class="bi bi-question"></i>
                                        </div>
                                        <div class="ps-3">
                                            <h6>45</h6>
                        ...
                        <div class="col-xxl-4 col-xl-12">
                            ...
                            <div class="card info-card customers-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Highest Rated Business</h5>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>Star bites</h6>
                                            <span class="text-danger small pt-1 fw-bold">5</span> <span class="text-muted small pt-2 ps-1">star rating</span>
