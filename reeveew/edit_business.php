...
$sql1="SELECT review.review_id, review.rating,review.review_comments,user_info.user_fname, user_info.user_lname
FROM review
...
?>
    ...
    <head>
        ...
        <title>Reeveew/Edit Business</title>
    ...
    <script>
        function deleteReview(review_id) {
            ...
            xhr.open("POST", "delete_review.php");
                ...
                <div class="card">
                    <div class="card-body pt-3">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Edit Business <i class="bi bi-pencil"></i></button>
                            </li>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <form action="update_business.php" method="POST">
                                    <input name="id" value="<?php echo $business_id; ?>" hidden="">
                                    <div class="row mb-3">
    ...
    ?>
    <table style="width: 70%;margin-left: 18%; margin-bottom: 5%" id="myTable" class="table table-striped">
        <thead>
        <tr>
        ...
        while($row = mysqli_fetch_assoc($result1)) {
            ...
            echo "<td><button style='background: none;border: none' type='button' onclick=\"deleteReview($review_id)\"><i style='color: red' class='bi bi-trash'></i></button></td>";
            echo "</tr>";
        }
        ?>
