...
if (isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO business_details (business_name, keywords, working_time,business_email, phone_num, description,location, category_id,location_id)
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        header("Location: admin_manage_businesses.php");
        exit();
    } else {
